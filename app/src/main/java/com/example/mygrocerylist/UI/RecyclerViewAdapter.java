...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(@NonNull View view, Context ctx) {
            ...
            groceryItemName = (TextView) view.findViewById(R.id.tv_name);

            quantity = (TextView) view.findViewById(R.id.tv_quantity);
            dateAdded = (TextView) view.findViewById(R.id.tv_dateAdded);

            editButton = (Button) view.findViewById(R.id.btn_editButton);
            deleteButton = (Button) view.findViewById(R.id.btn_deleteButton);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    //go ton next screen / DetailsActivity
...
//create AlertDialog
            ...
            Button noButton = (Button) view.findViewById(R.id.btn_noButton);
            Button yesButton = (Button) view.findViewById(R.id.btn_yesButton);
        ...
        public void editItem(final Grocery grocery) {
            ...
            final EditText groceryItem = (EditText) view.findViewById(R.id.et_groceryItem);
            final EditText quantity = (EditText) view.findViewById(R.id.et_groceryQty);
